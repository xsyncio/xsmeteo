"""
Synchronous client for Open-Meteo API.
"""
...
class XSMeteo:
    ...
    def request(self, request_def: RequestDef[T]) -> T:
        """
        ...
        request_def : RequestDef[T]
            The request definition containing URL, params, and response model.
